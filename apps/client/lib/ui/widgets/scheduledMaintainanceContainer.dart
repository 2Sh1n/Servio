...
class _ScheduledMaintenanceContainerState
  ...
  void _checkIfDismissed() {
    ...
    final startDateTime =
        widget.appSettings.customerAppMaintenanceModeStartDateTime;
  ...
  void _dismissWarning() {
    ...
    if (startDateTime != null) {
      HiveRepository.setLastSkippedMaintenanceScheduleWarning =
  ...
  Widget build(BuildContext context) {
    final startDateTime =
        widget.appSettings.customerAppMaintenanceModeStartDateTime;
    final endDateTime =
        widget.appSettings.customerAppMaintenanceModeEndDateTime;

    if (startDateTime == null ||
        endDateTime == null ||
        widget.appSettings.customerAppScheduleMaintenanceMode == false) {
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: UiUtils.formatDateTime(startDateTime),
                                  style: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    color: context.colorScheme.blackColor,
                                  ),
                                ...
                                TextSpan(
                                  text:
                                      '${UiUtils.formatDateTime(endDateTime)}.',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    color: context.colorScheme.blackColor,
                                  ),
