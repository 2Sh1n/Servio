...
const MetaData = ({
  ...
  const safeTitle = title || process.env.NEXT_PUBLIC_META_TITLE || 'Servio';
  ...
  const safeAuthor = author || process.env.NEXT_PUBLIC_APP_NAME || 'Servio';
  ...
  const safeSiteName = siteName || process.env.NEXT_PUBLIC_META_TITLE || 'Servio';
