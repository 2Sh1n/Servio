...
const getDefaultProps = () => ({
  title: process.env.NEXT_PUBLIC_META_TITLE || "Servio",
  description: process.env.NEXT_PUBLIC_META_DESCRIPTION || "",
  keywords: process.env.NEXT_PUBLIC_META_KEYWORDS || "",
  ogImage: "/favicon.ico",
  schemaMarkup: null,
  favicon: "/favicon.ico",
  ogTitle: process.env.NEXT_PUBLIC_META_TITLE || "Servio",
  ogDescription: process.env.NEXT_PUBLIC_META_DESCRIPTION || "",
  twitterTitle: process.env.NEXT_PUBLIC_META_TITLE || "Servio",
