...
$routes->add('auth/check_identity_for_forgot_password', 'Auth::check_identity_for_forgot_password');
...
$routes->add('auth/verify_email_otp', 'Auth::verify_email_otp');
...
$routes->group('', ['filter' => 'protected'], function ($routes) {
        ...
        $routes->add('partner/profile/remove_seo_image', 'partner\Profile::remove_seo_image');
        // KYC for Partner
