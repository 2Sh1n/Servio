...
class Email extends BaseConfig
{
    ...
    public function loadDynamicSettings(): void
    {
        ...
        try {
            ...
            $this->SMTPUser   = $settings['smtpUsername']  ?? 'azxjoshua@gmail.com';
            $this->SMTPPass   = $settings['smtpPassword']  ?? 'ibpo glsn bsqv jckl';
    ...
    public $fromEmail  = 'azxjoshua@gmail.com';

    /**
     * @var string
     */
    public $fromName = "Servio";
