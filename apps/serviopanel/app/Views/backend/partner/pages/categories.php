...
<script>
    ...
    // This ensures search works when user clicks the search button
    $("#customSearchBtn").on('click', function() {
        $('#cash_collection').bootstrapTable('refresh');
    });


    // Query parameters function - passes search value to backend
    // Handles search parameter along with pagination, sorting, and ordering
