            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row mt-4 mb-3">
                        <div class='btn bg-emerald-blue tag text-emerald-blue mr-2 ml-3 mb-2 filters_table cursor-pointer' id="service_filter" name="service_filter_all" value=""><?= labels('all', 'All') ?> </div>
                        <div class='btn bg-emerald-success tag text-emerald-success mr-2 filters_table cursor-pointer' id="service_filter_active" name="service_filter_active" value="service_filter"><?= labels('active', 'Active') ?> </div>
                        <div class='btn bg-emerald-danger tag text-emerald-danger mr-2 filters_table cursor-pointer' id="service_filter_deactive" name="service_filter_deactive" value="service_filter"><?= labels('deactive', 'Deactive') ?> </div>
                        ...
                        <table class="table table-hover table-borderd" data-fixed-columns="true" id="cash_collection" data-show-export="false"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="price" class="text-center" data-sortable="true"><?= labels('price', 'Price') ?>(<?= $currency ?>)</th>
                                    <th data-field="discounted_price" class="text-center" data-sortable="true"><?= labels('discounted_price', 'Discounted Price') ?>(<?= $currency ?>)</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var columns = [{
            ...
            {
                field: 'price',
                label: '<?= labels('price', 'Price') ?>(<?= $currency ?>)',
                visible: false
            },
            {
                field: 'discounted_price',
                label: '<?= labels('discounted_price', 'Discounted Price') ?>(<?= $currency ?>)',
                visible: false
            },
            {
                field: 'status_badge',
