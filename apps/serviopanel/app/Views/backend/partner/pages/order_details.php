                                                ...
                                                <div class=" mb-4 card-border">
                                                    <div class="" style="background-color:#f2f1f6;border-radius:0.3rem">
                                                        <ul class="text-dark" style="padding: 0;" class="mb-0">
                                                            <li class="flex items-center justify-between ml-2 mr-2 mt-1 pl-1 pt-3"><span><?= labels('total', 'Total') ?></span><span class="font-semibold"><?= $currency . ($order_subtotal ?? 0) ?></span></li>
                                                            <hr class="flex items-center justify-between   " style="border-color: #dde2e6;">
                                                            <li class="flex items-center justify-between  ml-2 mt-1  mr-2"><span><?= labels('tax_amount', "Tax Amount") ?></span><span class="font-semibold"><span class="bold"><?= $currency . ($order_tax_amount ?? 0) ?></span></span></li>
                                                            <hr class="flex items-center justify-between   " style="border-color: #dde2e6;">
                                                            <?php
                                                            ...
                                                            <li class="fbg-dark  flex items-center justify-between mb-lg-n5  p-3 " style="background-color: #DFDDEB;"><span> <?= labels('payable_total', "Payable Total") ?></span><span class="font-semibold"><?= $currency . ($order_final_total ?? 0) ?></span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card text-dark border-bottom" style="border: none!important;">
                                        <form id="myForm" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group  text-dark col-md">
                                                <select name="status" id="status" class="form-control select2 update_order_status" <?= (isset($order_details['status']) && !empty($order_details['status']) && ($order_details['status'] == "cancelled" || $order_details['status'] == "completed")) ? "disabled" : "" ?>>
                                            ...
                                            <div class="row m-0">
                                                <div class="col-md mt-3">
                                                    <?php if (isset($order_details['status']) && !empty($order_details['status']) && $order_details['status'] == "completed") { ?>
                                                        <a class="btn btn-md btn-primary text-white" href="<?= $base_url . '/partner/orders/invoice/' . $order_details['id'] ?>"> <i class="fa fa-receipt text-success mr-1"></i><?= labels('download_invoice', 'Download Invoice') ?></a>
                                                    <?php } elseif (isset($order_details['status']) && !empty($order_details['status']) && $order_details['status'] == "cancelled") { ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 relative">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-8 col-md-6">
                                                            <label for="" class="bold" style="word-break: break-all;"> <?= !empty($order_details['customer_email']) ? $order_details['customer_email'] : labels('no_data_found', 'No data found') ?></label>
                                                        </div>
                                                    </div>
                                                    <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-8 col-md-6">
                                                            <label for="" class="bold" style="word-break: break-all;"> <?= !empty($personal_data['email']) ? $personal_data['email'] : labels('no_data_found', 'No data found') ?></label>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-4 col-md-6">
