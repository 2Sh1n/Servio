                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-sm invoice-table" id="invoice_table" data-show-export="true" data-export-types="['txt','excel','csv']" data-export-options='{"fileName": "invoice-order-list","ignoreColumn": ["action"]}' data-auto-refresh="true" data-toggle="table" data-search-highlight="true" data-page-list="[5, 10, 25, 50, 100, 200, All]" data-url="<?= base_url('partner/orders/invoice_table/' . $order['id']); ?>" data-sort-order="DESC">
                                        <thead class="bg-primary text-light">
                                            <tr>
                                                <th class="border-0 text-left" data-field="service_title" data-sortable="true" data-visible="true"><?= labels('services', 'Service') ?></th>
                                                <th class="border-0 text-left" data-field="price" data-visible="true"><?= labels('price', 'Price') ?></th>
                                                <th class="border-0 text-left" data-field="discount" data-visible="true"><?= labels('discount', 'Discount Price') ?></th>
                                                <th class="border-0 text-left" data-field="net_amount" data-visible="true"><?= labels('net_amount', 'Net Amount') ?></th>
                                                <th class="border-0 text-left" data-field="tax" data-visible="true"><?= labels('tax', 'Tax') ?></th>
                                                <th class="border-0 text-left" data-field="tax_amount" data-visible="true"><?= labels('tax_amount', 'Tax Amount') ?></th>
                                                <th class="border-0 text-left" data-field="quantity" data-visible="true"><?= labels('quantity', 'Quantity') ?></th>
                                                <th class="border-0 text-left" data-field="subtotal" data-visible="true"><?= labels('sub_total_including_tax', 'Sub total (Including Tax)') ?></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
