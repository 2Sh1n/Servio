            ...
            <div class="col-md-4 col-sm-12">
                <div class="card d-flex h-100 pb-0 recent-activities">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h5>
                            <span class="dashboard_large_label">
                                <?php
                        ...
                        <div class="col-md-12 ">
                            <div class="ml-0">
                                <div class="h-full">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <input type="date" id="daily_quiz_date" name="daily_quiz_date" class="form-control">
                                        </div>
                                        <div class="col-sm-3"></div>
                                        <div class="col-6">
                                            <h5>
                                                <span class="dashboard_large_label d-flex dashboard_small_label justify-content-end text-dark">
                                                    <?= labels('recent_booking', 'Recent Booking') ?> :
                                                    <span class="" id="recent_booking"></span>
                                                </span>
                                            </h5>
                                        </div>
                                    </div>

                                    <table class="table" id="new-order"
                                        data-detail-formatter="user_formater"
                                        ...
                                        data-query-params="new_order_query_params"
        ...
        if ($("#sales").length > 0) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    var myChart = new Chart(document.getElementById('sales'), config);
                }
            });
        }
