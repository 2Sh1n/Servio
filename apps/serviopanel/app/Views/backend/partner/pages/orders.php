                    ...
                    <div class="row mt-4 mb-3">
                        ...
                        <div class="dropdown d-inline ml-2">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                <a class="dropdown-item" onclick="custome_export('pdf','odrer list','partner_bookings_list');"><?= labels('pdf', 'PDF') ?></a>
                                <a class="dropdown-item" onclick="custome_export('excel','odrer list','partner_bookings_list');"><?= labels('excel', 'Excel') ?></a>
                                <a class="dropdown-item" onclick="custome_export('csv','odrer list','partner_bookings_list')"><?= labels('csv', 'CSV') ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover table-borderd" data-fixed-columns="true" id="partner_bookings_list"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="final_total" class="text-center" data-visible="true"><?= labels('final_total', 'Final total') ?>(<?= $currency ?>)</th>
                                    <th data-field="partner" class="text-center" data-sortable="false" data-visible="false"><?= labels('provider', 'Provider') ?></th>
                                    <th data-field="total" class="text-center" data-visible="false"><?= labels('total', 'Total') ?>(<?= $currency ?>)</th>
