                    ...
                    <table class="table " data-fixed-columns="true" id="user_list" width="100%"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="total" class="text-center" data-sortable="true" data-visible="true"><?= labels('total', 'Total') ?></th>
                                <th data-field="promo_code" class="text-center" data-sortable="true" data-visible="false"><?= labels('promo_code', 'Promo Code') ?></th>
                                <th data-field="promo_discount" class="text-center" data-sortable="true" data-visible="true"><?= labels('promo_discount', 'Promo Discount') ?></th>
                                <th data-field="final_total" class="text-center" data-sortable="true" data-visible="true"><?= labels('final_total', 'Final Total') ?>(<?= $data['currency'] ?>)</th>
                                <th data-field="admin_earnings" class="text-center" data-sortable="true" data-visible="true"><?= labels('admin_earning', 'admin_earnings') ?>(<?= $data['currency'] ?>)</th>
                                ...
                                <th data-field="date_of_service" data-sortable="true" class="text-center" data-visible="true"><?= labels('date_of_service', 'Date of Service') ?></th>
                                <th data-field="new_start_time_with_date" data-sortable="true" class="text-center" data-visible="true"><?= labels('starting_time', 'Starting Time') ?></th>
                                <th data-field="new_end_time_with_date" data-sortable="true" class="text-center" data-visible="true"><?= labels('ending_time', 'Ending Time') ?></th>
                                <th data-field="duration" data-sortable="true" class="text-center" data-visible="true"><?= labels('duration', 'Duration') ?></th>
                                <th data-field="status" data-sortable="true" class="text-center" data-visible="true"><?= labels('status', 'Status') ?></th>
