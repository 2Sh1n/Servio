        ...
        <div class="row mb-4">
                ...
                <div class="card h-100">
                    <div class="row border_bottom_for_cards m-0">
                        <div class="col d-flex align-items-center justify-content-between">
                            <div class="toggleButttonPostition"><?= labels('light_theme_colors', "Light Theme Colors") ?></div>
                            <button type="button" class="btn btn-sm btn-outline-secondary reset-theme-btn" data-theme="light">
                                ...
                                <div class="form-group color-field-group">
                                    ...
                                    <div class="input-group">
                                        <div class="color-swatch-wrapper">
                                            <div class="color-swatch-preview" id="<?= $color['id'] ?>_preview" style="background-color: <?= $swatchVal ?>"></div>
                                            <input type="color" id="<?= $color['id'] ?>_picker" value="<?= $swatchVal ?>" title="<?= labels('choose_color', 'Choose Color') ?>" oninput="syncColorField('<?= $color['id'] ?>', this.value)">
                                        </div>
                                        <input type="text" class="form-control color-picker-input" name="<?= $color['id'] ?>" id="<?= $color['id'] ?>" value="<?= $val ?>" maxlength="9" oninput="syncColorSwatch('<?= $color['id'] ?>', this.value)">
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
            ...
            <div class="col-md-6 col-sm-12 col-xl-6">
                <div class="card h-100">
                    <div class="row border_bottom_for_cards m-0">
                        <div class="col d-flex align-items-center justify-content-between">
                            <div class="toggleButttonPostition"><?= labels('dark_theme_colors', "Dark Theme Colors") ?></div>
                            <button type="button" class="btn btn-sm btn-outline-secondary reset-theme-btn" data-theme="dark">
                                <i class="fas fa-undo-alt"></i> <?= labels('reset_to_default', 'Reset to Default') ?>
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('click', '.reset-theme-btn', function() {
        ...
        $.ajax({
            ...
            error: function() {
                iziToast.error({ title: '', message: '<?= labels('SOMETHING_WENT_WRONG', SOMETHING_WENT_WRONG) ?>', position: 'topRight' });
            },
            complete: function() {
