                                            ...
                                            <?php if ($permissions['update']['orders'] == 1) { ?>
                                                <div class="row m-0">
                                                    <div class="col-md mt-3">
                                                        <?php if (isset($order_details['status']) && !empty($order_details['status']) && $order_details['status'] == "completed") { ?>
                                                            <a class="btn btn-md btn-primary text-white" href="<?= $base_url . '/admin/orders/invoice/' . $order_details['id'] ?>"> <i class="fa fa-receipt text-success mr-1"></i><?= labels('download_invoice', 'Download Invoice') ?></a>
