        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('admin/partners/cash_collection_deduct') ?>" method="post" class="form-submit-event" id="pay-out-form" novalidate="novalidate">
...
<script>
    ...
    // Refresh cash collection table after successful form submission
    // This listens for successful AJAX responses from the cash_collection_deduct endpoint
    $(document).ajaxSuccess(function(event, xhr, settings) {
        // Check if this is our cash collection form submission
        if (settings.url && settings.url.indexOf('cash_collection_deduct') !== -1) {
            try {
                var response = JSON.parse(xhr.responseText);
                if (response.error === false) {
                    // Refresh the cash collection table after successful submission
                    setTimeout(function() {
                        $('#cash_collection').bootstrapTable('refresh');
