...
class PaymentRefunds extends Admin
{
    ...
    public function updateStatus()
    {
        try {
            ...
            // Update the transaction status. Use 'manual_refund' so the UI shows "Manual Refund"
            // instead of "Xendit Refund" for non-Xendit or manually processed gateways.
            $updated = $this->refundModel->updateTransactionStatus($transactionId, 'success', 'manual_refund');
