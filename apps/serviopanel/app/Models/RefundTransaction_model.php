...
class RefundTransaction_model extends Model
{
     ...
     * @param string|null $message Optional message key for display (e.g. 'manual_refund', 'xendit_refund').
     *        When admin manually approves a refund, pass 'manual_refund' so the UI shows "Manual Refund"
     *        instead of "Xendit Refund". Omit or pass 'xendit_refund' for Xendit gateway updates.
     * @return bool True if update successful, false otherwise
     */
    public function updateTransactionStatus($transactionId, $status, $message = 'xendit_refund')
    {
        try {
